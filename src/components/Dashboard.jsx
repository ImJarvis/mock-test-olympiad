...
export default function Dashboard() {
  const {
    ...
    longestStreak, unlockedStickers, startNextQuest, goHome, theme, character
  } = useGameStore();
          ...
          {view === 'kid' ? (
            ...
            >
              <div style={{
                ...
                <p style={{ fontSize: '1.4rem', fontWeight: 800, margin: 0, lineHeight: 1.4 }}>
                  Wow {kidName}! 🚀<br />
                  You've beaten {questsCompleted} quest{questsCompleted !== 1 && 's'} and gathered {totalXP} XP!<br />
                  Your longest streak is {longestStreak} 🔥. Keep being awesome!
                </p>
                <div style={{
              ...
              <motion.div 
                ...
                style={{ width: '240px', height: '240px', filter: 'drop-shadow(0 12px 24px rgba(0,0,0,0.2))' }}
              >
